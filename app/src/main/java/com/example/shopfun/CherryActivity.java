...
public class CherryActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_cherry);
        ...
        CherryAdapter adapter = new CherryAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Cherry");
                Toast.makeText(CherryActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

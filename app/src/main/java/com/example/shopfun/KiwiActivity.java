...
public class KiwiActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_kiwi);
        ...
        KiwiAdapter adapter = new KiwiAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Kiwi");
                Toast.makeText(KiwiActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

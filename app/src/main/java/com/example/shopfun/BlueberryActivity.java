...
public class BlueberryActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_blueberry);
        ...
        BlueberryAdapter adapter = new BlueberryAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Blueberry");
                Toast.makeText(BlueberryActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

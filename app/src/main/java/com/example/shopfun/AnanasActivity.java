...
public class AnanasActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_ananas);
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_ananas);
        ...
        AnanasAdapter adapter = new AnanasAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Ananas");
                Toast.makeText(AnanasActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

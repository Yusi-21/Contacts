...
public class CabbageActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_vegetable);
        ...
        CabbageAdapter adapter = new CabbageAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Cabbage");
                Toast.makeText(CabbageActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

...
public class WatermelonActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_watermelon);
        ...
        WatermelonAdapter adapter = new WatermelonAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Watermelon");
                Toast.makeText(WatermelonActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

...
public class PistachioActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_pistachio);
        ...
        PistachioAdapter adapter = new PistachioAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Pistachio");
                Toast.makeText(PistachioActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

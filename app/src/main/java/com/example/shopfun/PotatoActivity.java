...
public class PotatoActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_potato);
        ...
        PotatoAdapter adapter = new PotatoAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Potato");
                Toast.makeText(PotatoActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

...
public class PearActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_pear);
        ...
        PearAdapter adapter = new PearAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Pear");
                Toast.makeText(PearActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

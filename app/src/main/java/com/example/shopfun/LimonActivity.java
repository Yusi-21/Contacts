...
public class LimonActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_limon);
        ...
        LimonAdapter adapter = new LimonAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Limon");
                Toast.makeText(LimonActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

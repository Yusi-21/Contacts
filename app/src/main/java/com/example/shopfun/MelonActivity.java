...
public class MelonActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_melon);
        ...
        MelonAdapter adapter = new MelonAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Melon");
                Toast.makeText(MelonActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

...
public class TomatoActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_tomato);
        ...
        TomatoAdapter adapter = new TomatoAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Tomato");
                Toast.makeText(TomatoActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

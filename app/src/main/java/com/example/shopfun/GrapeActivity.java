...
public class GrapeActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_grape);
        ...
        GrapeAdapter adapter = new GrapeAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Grape");
                Toast.makeText(GrapeActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

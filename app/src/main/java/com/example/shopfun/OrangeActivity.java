...
public class OrangeActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_orange);
        ...
        OrangeAdapter adapter = new OrangeAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Orange");
                Toast.makeText(OrangeActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

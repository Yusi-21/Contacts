...
public class CucumberActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_cucumber);
        ...
        CucumberAdapter adapter = new CucumberAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Cucumber");
                Toast.makeText(CucumberActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }

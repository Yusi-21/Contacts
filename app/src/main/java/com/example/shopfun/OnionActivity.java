...
public class OnionActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ListView contentList = findViewById(R.id.content_list_onion);
        ...
        OnionAdapter adapter = new OnionAdapter(this, items);
        ...
        addToCatalogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Catalog.getInstance().addItem("Onion");
                Toast.makeText(OnionActivity.this, "Product added to catalog", Toast.LENGTH_SHORT).show();
            }
        });
    }
